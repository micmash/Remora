...
public class RoboSignInBadPassword extends ActivityInstrumentationTestCase2 {
  	private Solo solo;
    ...
    public RoboSignInBadPassword() throws ClassNotFoundException {
	...
	public void testRun() {
        ...
        //Enter the text: 'vsidvei36283%'
		solo.clearEditText((android.widget.EditText) solo.getView("password"));
		solo.enterText((android.widget.EditText) solo.getView("password"), "vsidvei36283%");
        //Click on Sign in
