 ...
 */
public class ViewEvents extends ActivityInstrumentationTestCase2 {
    private Solo solo;
    ...
    public ViewEvents() throws ClassNotFoundException {
    ...
    public void testRun() {
        ...
        assertTrue("GetGroupsFromAccountActivity is not found!", solo.waitForActivity("GetEventsFromAccount"));
